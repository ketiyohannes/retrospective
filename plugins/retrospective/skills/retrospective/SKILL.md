---
name: retrospective
description: Review completed Codex or Claude Code work and preserve concise, reusable lessons in the local retrospective knowledge base. Use after a work session, when an automatic retrospective continuation requests it, or when the user asks what worked, failed, became stuck, or changed.
---
